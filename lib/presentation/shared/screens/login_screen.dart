...
import '../widgets/elevator_loading_gate.dart';
...
class _LoginScreenState extends State<LoginScreen>
  ...
  Future<void> _submitForm() async {
    ...
    setState(() {
      _submitting = true;
      _showFullScreenLoading = _isRegisterMode;
    });
    ...
    try {
      ...
      if (message.contains('already registered') ||
        ...
        message =
            'Tu correo electrónico no ha sido verificado. Por favor, revísalo.';
      }
  ...
  Widget build(BuildContext context) {
    ...
    return ElevatorLoadingGate(
      loading: _showFullScreenLoading,
      child: Scaffold(
        backgroundColor: const Color(
          0xFFFCFBF8,
        ), // Fondo crema claro vintage de clientes
        body: Stack(
          children: [
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Card(
                          ...
                          color: const Color(
                            0xFFFAF5E6,
                          ), // Fondo crema cálido premium para la tarjeta
